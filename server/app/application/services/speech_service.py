/// SpeechService
/// 
/// A service class for processing audio files and extracting text via speech recognition. // Eine Service-Klasse zur Verarbeitung von Audiodateien und Extraktion von Text mittels Spracherkennung.
/// Handles wake word detection, audio format conversion, and speech-to-text processing. // Behandelt die Erkennung von Aktivierungswörtern, Audioformat-Konvertierung und Sprache-zu-Text-Verarbeitung.
/// 
/// Usage:
/// ```python
...
/// command = await speech_service.process_command("audio_file.wav")
/// 
/// # Convert speech to text
/// text = await speech_service.process_audio("audio_file.mp3")
/// ```
/// 
/// EN: Provides audio processing capabilities using Azure Speech Services and Google Speech Recognition.
/// DE: Bietet Audioverarbeitungsfunktionen mit Azure Speech Services und Google Spracherkennung.
